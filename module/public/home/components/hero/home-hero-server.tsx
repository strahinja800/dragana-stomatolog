...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden max-md:mt-0">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10 max-lg:m-20 max-lg:mt-0 max-lg:max-w-full max-sm:mx-0 max-sm:mb-0">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-up">
            ...
            <h1 className="text-3xl md:text-6xl xl:text-8xl font-heading font-bold text-primary-foreground leading-tighter max-[1280px]:text-2xl">
              Stomatologija koja
