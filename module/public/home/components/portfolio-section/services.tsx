    ...
    <>
      {props.map((item, index) => (
        ...
        >
          ...
          {/* 3D Image */}
          <div className="absolute -right-8 -bottom-8  w-35 h-35 md:w-40 md:h-40 opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500">
            <Image
              src={item.image}
              alt={item.title}
