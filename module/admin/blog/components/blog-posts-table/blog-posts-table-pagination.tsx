...
interface BlogPostsTablePaginationProps<TData> {
  table: Table<TData>;
}

export function BlogPostsTablePagination<TData>({
  table,
}: BlogPostsTablePaginationProps<TData>) {
  return (
    <div className="flex items-center justify-between px-2">
      <div className="flex-1 text-sm text-muted-foreground">
        Ukupno članaka: {table.getFilteredRowModel().rows.length}
      </div>
