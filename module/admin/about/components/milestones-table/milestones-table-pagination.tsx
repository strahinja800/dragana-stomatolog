...
interface MilestonesTablePaginationProps<TData> {
  table: Table<TData>;
}

export function MilestonesTablePagination<TData>({
  table,
}: MilestonesTablePaginationProps<TData>) {
  return (
    <div className="flex items-center justify-between px-2">
      <div className="flex-1 text-sm text-muted-foreground">
        Ukupno postignuća: {table.getFilteredRowModel().rows.length}
      </div>
