...
import {
  type AboutValue,
  aboutValuesColumns,
} from './about-values-table-columns';
...
export function AboutValuesTable({
  data,
  onEdit,
  onDelete,
  onToggleActive,
}: AboutValuesTableProps) {
  ...
  return (
    <div className="space-y-4">
      <DataTableToolbar
        ...
        searchPlaceholder="Pretraži vrednosti..."
      />
        ...
        <Table>
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell
                  colSpan={aboutValuesColumns.length}
      ...
      <DataTablePagination table={table} totalLabel="Ukupno vrednosti:" />
    </div>
  );
}

export { type AboutValue } from './about-values-table-columns';
