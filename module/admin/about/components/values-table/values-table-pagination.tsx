...
interface ValuesTablePaginationProps<TData> {
  table: Table<TData>;
}

export function ValuesTablePagination<TData>({
  table,
}: ValuesTablePaginationProps<TData>) {
  return (
    <div className="flex items-center justify-between px-2">
      <div className="flex-1 text-sm text-muted-foreground">
        Ukupno vrednosti: {table.getFilteredRowModel().rows.length}
      </div>
