...
interface TeamTablePaginationProps<TData> {
  table: Table<TData>;
}

export function TeamTablePagination<TData>({
  table,
}: TeamTablePaginationProps<TData>) {
  return (
    <div className="flex items-center justify-between px-2">
      <div className="flex-1 text-sm text-muted-foreground">
        Ukupno članova: {table.getFilteredRowModel().rows.length}
      </div>
